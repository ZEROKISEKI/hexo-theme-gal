...
之前一些朋友也在issue里面反应了一些问题, 这个主体有些方面可能还有点问题, 有些方面还没有完成(代码高亮之类), 并且还
还有一些新功能想添加(比如离线音乐之类的), 由于近段时间要准备面试, 所以有些地方有问题或者还没解决还请见谅, 如果朋友们发现了什么问题或者有什么更好的建议, 欢迎提issue, 我到时会统一处理

另外, 有个小小的建议, 这个主体可能需要配置比较多的图片, 图片比如好几百kb甚至上m的加载会慢, 这点可以用一些网站进行图片压缩, 然后把图片放在一些对象存储空间上(比如七牛的对象存储空间),
